...
export default function ProgramProfile() {
    ...
    // const program = JSON.stringify(state.program);
    ...
    const requestProgramProfile = {
      ...
      useEffect(() => {
        // fetch(`${BASE_API}/organizations/{organization.id}/programs/{program.id}`, requestProgramProfile)
        fetch(`${BASE_API}/organizations/1/programs/1`, requestProgramProfile)
          .then(async response => {
            const data = await response.json();
            if (response.ok){
                console.log(data)
              return setProgram(data);
            }
    ...
    return (
        <div className="container" id="programProfile">
                        ...
                        <div className="input-group mb-3">
                            <p className="input-control">
                                ...
                                <select className="custom-select" name="target_candidate_socio_economic">
                                    ...
                                    {SOCIO_ECONOMIC.map((target_candidate_socio_economic) => optionsWithDefaultSelection(target_candidate_socio_economic, target_candidate_socio_economic))}
                                </select>
                            </p>
                        </div>
                        <div><br></br></div>
