...
export default function Login() {
    ...
    // const [session, setSessionContext] = useState({});
            ...
            .then(async response => {
                ...
                if (response.status === 200) {
                    if (data !== {}) {
                        ...
                        // const AccessTokenContext = createContext(access_token);
    ...
    // const session = useContext(getSessionCookie());
    ...
    if (isAuthenticated) {
        ...
        console.log(Cookies.get("access_expiry"));
